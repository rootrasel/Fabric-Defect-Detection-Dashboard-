    ...
    >
      <div className="flex items-center gap-4">
        <div className="w-14 h-14 rounded-2xl bg-gray-100 flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26" className="opacity-70">
            <path
              fill="currentColor"
        ...
        <div className="flex-1">
          <div className="text-sm text-gray-600">Upload an image or drag & drop.</div>
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <span className="text-xs text-gray-500">or drop an image here</span>
          </div>
          <input
            ref={inputRef}
            type="file"
          ...
          <button onClick={callPredict} className="btn btn-primary mt-8 flex items-center justify-center w-full">Prediction</button>
    </div>
  );
}
